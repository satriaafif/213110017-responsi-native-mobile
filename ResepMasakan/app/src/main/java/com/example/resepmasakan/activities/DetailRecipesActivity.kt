                    ...
                    try {
                        ...
                        try {
                            ...
                            Toast.makeText(this@DetailRecipesActivity,
                                "Oops, gagal menampilkan bahan-bahan masakan.", Toast.LENGTH_SHORT
                            ).show()
                        }
                        ...
                        try {
                            ...
                            e.printStackTrace()
                            Toast.makeText(this@DetailRecipesActivity,
                                "Oops, gagal menampilkan langkah pembuatan masakan.",
                                Toast.LENGTH_SHORT
                            ).show()
                        }
                    } catch (e: JSONException) {
                        e.printStackTrace()
                        Toast.makeText(this@DetailRecipesActivity,
                            "Oops, gagal detail resep masakan.", Toast.LENGTH_SHORT
                        ).show()
                    }
